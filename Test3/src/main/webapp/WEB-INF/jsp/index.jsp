...
<div id="jumbotron">
    <div class="container">
        <div class="info">
            ...
            <p class="text-white" data-aos="fade-down" data-aos-duration="1500">
...
<div class="bg" >
    <div class="bg-location">
        <div class="info-location">
            <p class="" data-aos="fade-left" data-aos-duration="2000"><span>" </span>
...
<video class="video-fluid z-depth-1"  loop controls muted style="width: 100%; height: 720px;">
...
<div class="bg-2" >
    <div class="info-location-2">
        <p class="" data-aos="fade-right" data-aos-duration="2000"><span>" </span>Là một con dân nước Việt Nam nhưng mấy ai 
...
<div class="container">
    <h3 class="">Các điểm đến nổi bật</h3>
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-8" data-aos="zoom-in-up" data-aos-duration="1600">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="mb-4"  data-aos="zoom-in-left" data-aos-duration="1300">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-6 col-md-4" data-aos="zoom-in-right" data-aos-duration="1700">
            <div class="mb-4">
        ...
        <div class="col-xs-12 col-sm-6 col-md-8" data-aos="zoom-in-up" data-aos-duration="2000">
            <a href="<c:url value="/dsTour?kw=Cao+bằng"/>">
...
<div class="bg-diem-den d-flex justify-content-center align-items-center">
    <div class="ket-thuc text-center px-3">
        <p class="my-auto Oswald" data-aos="fade-up" data-aos-duration="2000">Chúng ta chỉ có duy nhất một lần làm người trẻ.
...
<div class="bg-ket-thuc bg-ket-thuc-3">
</div>