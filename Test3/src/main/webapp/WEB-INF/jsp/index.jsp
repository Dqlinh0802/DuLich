...
<div id="jumbotron">
    <div class="container">
        <div class="info">
            ...
            <div>
                <a class="btn btn-success text-white"  href="<c:url value="/dsTour"/>">Xem tour</a>
                <a class="btn btn-success text-white ml-2"  href="<c:url value="/dsTour"/>">Đặt tour</a>
            </div>
        </div>
    </div>
</div>
...
<div class="bg">
    <div class="bg-location">
        <div class="info-location">
            <p class=""><span>" </span>Du lịch mang đến những trải nghiệm thực tế về cuộc sống,
...
<div class="bg-diem-den d-flex justify-content-center align-items-center">
    <div class="ket-thuc text-center">
        <p class="my-auto Oswald">Chúng ta chỉ có duy nhất một lần làm người trẻ.
